...
ui_print ""
  ...
  ui_print "▌CODENAME ▰ STRP x UNLOCKER"
...
ui_print " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  ui_print " "
  sleep 2
  ui_print "▌Completly Reworked Menu To Choose Desired Game!"
   ui_print ""
  sleep 0.5
  ui_print "▌For using NEW UNLOCKER MENU"
  sleep 0.5
  ui_print "▌Type 'su -c UNLOCKER' - into Termux!"
ui_print ""
ui_print " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
sleep 4
ui_print " "
...
[[ "$IS64BIT" == "true" ]] && tar -xf "$MODPATH/unl64.tar.xz" -C "$MODPATH" || tar -xf "$MODPATH/unl32.tar.xz" -C "$MODPATH"
sleep 2.5
ui_print "║"
...
on_install() {
  ui_print "▌Installing STRP x UNLOCKER ▌"
  ui_print " "
  sleep 1
